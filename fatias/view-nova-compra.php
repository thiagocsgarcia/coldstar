	...
	<div class="col-md-12">
		...
		<h3 class="alert-info"> NOVA COMPRA</h3>		
			...
			<div class="col-md-4" align="right">
				...
				<h1 class="bg-black-fosco" align="center"> À pagar R$ <b id='total'>0.00 </b> </h1>
				...
				<button id='btnFecharCompra' class="btn btn-sm btn-success" href="" data-toggle='modal' data-target='#modalFechamentoCompra' onclick="somaTodosProdutos();" role="button"> Fechar Compra </button>
			    ...
			    <div class="modal-body col-md-12" align="" style="background-color: #333333">
					...
					<div class="col-md-12">
							...
							<div class=" col-md-6">
								...
								<h3 class="bg-black-fosco" id='numerosFinais'>	
									<b class="bg-black-fosco" align="center" id=""> Total à Pagar R$ </b>	
									<b class="bg-black-fosco" align="center" id="totalApagar"> 0.00 </b>	
								</h3>

								 
								 <h2 class="vermelho-laranja" id='numerosFinais'>	
									 <b class="" align="center" id="totalLabel"> Valor à Pagar R$ </b>	
									 <b class="" align="center" id="valorApagar"> 0.00 </b>	
								 </h2>
			      			...
			      			<div class=" col-md-6">
								...
								<table class="table table-condensed bg-black-fosco" id='tabelaCodigos' style="font-size:10px;">
					      		...
					      		<div class="form-inline">					      			
					      			<input type="text" class="form-control input-sm" id='txtValorApagar' onkeyup="mascara(this, mvalorAmerican);" placeholder='digite valor à pagar' disabled="disabled" />
					      			<button id='btnAdicionaPagto' class="btn btn-sm btn-info" onclick="atualizaFormaPagamento()" disabled="disabled"> Adicionar </button>
					      		</div>
